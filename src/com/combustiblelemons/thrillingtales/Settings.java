...
public class Settings {
	...
	private static final String[][] KEYS = {{KEY_VILLAINS, KEY_VILLAINS_FILES},
	...
	/**
	 * Use it to write all the necessary information via SharedPreferences class.
	 * @param write TRUE to write all the configuration.
	...
	/**
	 * Use settings.getFiles to retrieve file names associated with a particular itemName
 
	 * <b>villains, locations, hook, descriptor1, descriptor2, fiendishplan1, fiendishplan2</b>
	 * <b>DEPRECATE</b>
	 * @param itemName  
	...
	public File getSettingsFile(){ return new File(this.getSettingsFileAbsolutePath());	}
	
	public boolean Exist(){	return new File(this.getSettingsFileAbsolutePath()).exists(); }
	
	public String getDescriptionsFileName(){ return Settings.DESCRIPTIONS_FILE;}
	/**
	 * 
	 * @param itemName tables name
	...
	/**
	 * Returns first column of every row in table KEYS from settings. <p>
