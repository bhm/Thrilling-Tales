...
public class Values {
	...
	protected static class Preferences {
		protected static final class Themes {
			protected static final int Mucha = 1;
			protected static final int Pulp = 2;
			protected static final int MouthfulOfDirt = 3;
			protected static final int WineFroyo = 4;
			protected static final int Vivviane = 5;

			public static int getTheme(int themeId) {
				switch (themeId) {
				case 1:
					return R.style.Theme_mucha;
				case 2:
					return R.style.Theme_pulp;
				case 3:
					return R.style.Theme_Mouthfulofdirt;
				case 4:
					return R.style.Theme_Winefroyo;
				case 5:
					return R.style.Theme_Vivviane;
				default:
					return R.style.Theme_mucha;
				}
			}
		...
		protected static final String THEME_KEY = "theme_key";
		...
		protected static final String DEFAULT_S_THEME = "1";
	}
	...
	protected static class SettingValues {
		...
		protected static final String[][] KEYS = { { KEY_VILLAINS, KEY_VILLAINS_FILES },
				{ KEY_FIENDISH_PLANS, KEY_FIENDISH_PLANS_FILES }, { KEY_LOCATION, KEY_LOCATION },
				{ KEY_HOOK, KEY_HOOK }, { KEY_SUPPORTING_CHARACTER, KEY_SUPPORTING_CHARACTER_FILES },
				{ KEY_SEQUENCES, KEY_SEQUENCES_FILES }, { KEY_PARITICPANTS, KEY_PARITCIPANTS_FILES },
				{ KEY_COMPLICATIONS, KEY_COMPLICATIONS_FILES }, { KEY_SETTINGS, KEY_SETTINGS_FILES },
				{ KEY_PLOT_TWIST, KEY_PLOT_TWIST_FILES }, { KEY_DESCRIPTIONS, DESCRIPTIONS_FILE },
	...
	protected static final class Villains extends Table {
		...
		protected final static String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + VILLAIN + " TEXT);";
	}
	...
	protected static final class Fiendishplans extends Table {
		...
		protected final static String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + FIENDISHPLAN1 + " TEXT, " + FIENDISHPLAN2 + " TEXT);";
	}
	...
	protected static final class Locations extends Table {
		...
		protected final static String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + LOCATION + " TEXT);";
	}
	...
	protected static final class Hooks extends Table {
		...
		protected final static String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + HOOKS + " TEXT);";
	}
	...
	protected static final class SupportingCharacters extends Table {
		...
		protected final static String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + DESCRIPTIOR1 + " TEXT, " + DESCRIPTIOR2 + " TEXT, " + TYPE
				+ " TEXT);";
	}
	...
	protected static final class PlotTwist extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + PLOTTWIST + " TEXT);";
	}
	...
	protected static final class Sequences extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + SEQUENCES + " TEXT);";
	}
	...
	protected static final class Participants extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + PARTICIPIANTS + " TEXT);";
	}
	...
	protected static final class Complications extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + COMPLICATIONS + " TEXT);";
	}
	...
	protected static final class Setting extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + SETTINGS + " TEXT);";
	}
	...
	protected static final class Descriptions extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + ITEM + " TEXT, " + DESCRIPTIONS + " TEXT);";
	}
	...
	protected static final class SavedScript extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + DATE + " TEXT, " + TITLE + " TEXT, " + VILLAIN + " TEXT, "
				+ LOCATION + " TEXT, " + FIENDISHPLAN1 + " TEXT, " + FIENDISHPLAN2 + " TEXT, " + HOOK + " TEXT);";
	}
	...
	protected static final class SavedAct extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + DATE + " TEXT, " + TITLE + " TEXT, " + ACT_TITLE + " TEXT,"
				+ SETTING + " TEXT, " + SEQUENCE + " TEXT, " + COMPLICATIONS + " TEXT, " + PARTICIPANTS + " TEXT, "
				+ PLOTTWIST + " TEXT);";
	}
	...
	protected static final class SavedSupport extends Table {
		...
		protected static final String CREATION_STRING = "CREATE TABLE IF NOT EXISTS " + NAME + " (" + ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + DATE + " TEXT, " + TITLE + " TEXT, " + DESCRIPTOR1
				+ " TEXT, " + DESCRIPTOR2 + " TEXT, " + TYPE + " TEXT);";
	}

	protected static final String[] MAIN_CREATION_STRINGS = { Villains.CREATION_STRING, Fiendishplans.CREATION_STRING,
			Locations.CREATION_STRING, Hooks.CREATION_STRING, SupportingCharacters.CREATION_STRING,
			Sequences.CREATION_STRING, Participants.CREATION_STRING, Complications.CREATION_STRING,
			Setting.CREATION_STRING, PlotTwist.CREATION_STRING, Descriptions.CREATION_STRING, };

	protected static final String[] MAIN_TABLES = { Villains.NAME, Fiendishplans.NAME, Locations.NAME, Hooks.NAME,
			SupportingCharacters.NAME, Sequences.NAME, Participants.NAME, Complications.NAME, Setting.NAME,
			PlotTwist.NAME, Descriptions.NAME };

	protected static final String[] SCRIPTS_CREATION_STRINGS = { SavedScript.CREATION_STRING, SavedAct.CREATION_STRING,
			SavedSupport.CREATION_STRING };

	protected static final String[] SCRITP_TABLES = { SavedScript.NAME, SavedAct.NAME, SavedSupport.NAME };
}
